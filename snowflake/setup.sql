...
GRANT ALL PRIVILEGES ON TABLE DPWH_PROJECTS_DB.RAW.RAW_DPWH_PROJECTS TO ROLE DATA_ENGINEER;


GRANT ALL PRIVILEGES ON FUTURE TABLES IN SCHEMA DPWH_PROJECTS_DB.RAW TO ROLE DATA_ENGINEER;
GRANT ALL PRIVILEGES ON FUTURE TABLES IN SCHEMA DPWH_PROJECTS_DB.DEV TO ROLE DATA_ENGINEER;
GRANT ALL PRIVILEGES ON FUTURE TABLES IN SCHEMA DPWH_PROJECTS_DB.PROD TO ROLE DATA_ENGINEER;

GRANT ALL PRIVILEGES ON TABLE DPWH_PROJECTS_DB.RAW.RAW_DPWH_PROJECTS TO ROLE DATA_ENGINEER;
GRANT ALL PRIVILEGES ON TABLE DPWH_PROJECTS_DB.RAW.RAW_DPWH_PROJECTS_STAGING TO ROLE DATA_ENGINEER;
